...
public class ProductRecyclerFragment extends Fragment {
    ...
    private static final String TAG = ProductRecyclerFragment.class.getSimpleName();
    ...
    public static ProductRecyclerFragment newInstance(String param1) {
        ProductRecyclerFragment fragment = new ProductRecyclerFragment();
    ...
    public ProductRecyclerFragment() {
    }
